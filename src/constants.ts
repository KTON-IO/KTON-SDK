...
export const CONTRACT = {
  // KTON contracts
  KTON_STAKING_CONTRACT_ADDRESS: "EQA9HwEZD_tONfVz6lJS0PVKR5viEiEGyj9AuQewGQVnXPg0",
  KTON_STAKING_CONTRACT_ADDRESS_TESTNET: "kQD2y9eUotYw7VprrD0UJvAigDVXwgCCLWAl-DjaamCHniVr",
  
  // pKTON contracts
  PKTON_STAKING_CONTRACT_ADDRESS: "EQDsW2P6nuP1zopKoNiCYj2xhqDan0cBuULQ8MH4o7dBt_7a",
  PKTON_STAKING_CONTRACT_ADDRESS_TESTNET: "kQD2y9eUotYw7VprrD0UJvAigDVXwgCCLWAl-DjaamCHniVr",
